...
export default function Layout() {
  ...
  const NAV = [
    ...
    { path:'/consultations', label: lang==='ar'?'الاستشارات الهندسية':'Consultations', icon:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path d="M8 1a6 6 0 100 12A6 6 0 008 1z" stroke="currentColor" strokeWidth="1.2"/><path d="M8 5v3l2 2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg> },
