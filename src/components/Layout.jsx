...
export default function Layout() {
  ...
  const NAV = [
    ...
    { path:'/project-visits', label: lang==='ar'?'زيارات المشاريع':'Project Visits', icon:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path d="M2 3h5l1.5 2H14v8H2V3z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/><path d="M6 9h4M6 12h2" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg> },
    ...
    { path:'/periodic-supervision', label: lang==='ar'?'الإشراف الدوري':'Periodic Supervision', icon:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="currentColor" strokeWidth="1.2"/><path d="M8 4.5V8l2.5 1.5" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/><path d="M13.5 3.5l1 1" stroke="currentColor" strokeWidth="1.3" strokeLinecap="round"/></svg> },
    { path:'/period-report', label: lang==='ar'?'التقرير الدوري':'Period Report', icon:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><rect x="2" y="2" width="12" height="12" rx="1.5" stroke="currentColor" strokeWidth="1.2"/><path d="M5 10V7M8 10V5M11 10v-2" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg> },
