...
const NAV = [
  ...
  { path:'/drawings', label:'Drawings', icon:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path d="M2 12L6 4l4 6 2-3 3 5H2z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/></svg> },
    ...
    <div className="app">
      ...
      <div className={`sidebar ${sidebarOpen?'open':''}`}>
        <div className="sidebar-logo" style={{padding:'14px 16px'}}>
          <img src="/rekaz-logo.jpg" alt="Rekaz" style={{width:'100%', maxWidth:140, height:'auto', borderRadius:6, display:'block', background:'white', padding:'6px'}}/>
